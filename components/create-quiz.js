    ...
    <div class="create__room">
        ...
        <div class="content">
            ...
            <div class="create_quiz">
                <div class="topic">
                <input id="category" type="text" placeholder="Add categories to the questionnaire ">
                </div>
...
class CreateQuiz extends HTMLElement{
    ...
    SaveToFirebase(){
        ...
        .addEventListener('click', async ()=>{
            this.topicOfQuiz = this._shadowDOM.getElementById('category');
            ...
            listCauHoi['topic'] = $(this.topicOfQuiz).val();
